...
function getHeader($index){
	...
	switch($index){
		...
		break;
		case 1:
			$return = str_replace('<li><a href="/portal">','<li class="active"><a href="/portal">',$return);
		break;
		case 2:
...
function getPreLoader(){
	echo '	<div id="preloader"><span></span><span></span><span></span><span></span><span></span></div>';
}
//获取各种样式
