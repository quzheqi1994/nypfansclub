var musicList = [
    {name: "搜索结果",cover: "",creatorName: "",creatorAvatar: "",item: []},
    {name: "正在播放",cover: "",creatorName: "",creatorAvatar: "",item: []},
    {name: "播放历史",cover: "images/history.png",creatorName: "",creatorAvatar: "",item: []},
    {id: 50001}
];
// 播放器功能配置
var mkPlayer = {
    api: "api_info.php", // api地址
